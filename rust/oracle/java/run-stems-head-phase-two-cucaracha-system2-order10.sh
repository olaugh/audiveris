...
if [ "$base_runner_sha" != "d1e2a3dd39c1f2f73b8ffc7d907e5361f33bbbd57a7dbf3ad68e3cc11ae0973c" ] || \
        [ "$base_fixture_sha" != "e7d97fbf829b52730dfdf4f219a0a7fd87cde3a8f7f8f301c788746492529f01" ] || \
