...
if [ "$base_runner_sha" != "108335295251f6205234a815616ad45d9fb5244e8ebfc11ab8fb5a567c65caf0" ] || \
        [ "$base_fixture_sha" != "fe1331b0de1990fdd0682b6a940804c6c26128c89bf0774cebb4404d2a591ca0" ] || \
