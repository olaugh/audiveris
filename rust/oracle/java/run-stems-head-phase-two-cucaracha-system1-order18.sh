...
if [ "$base_runner_sha" != "1db2d0e60d919fa18f0d8be433a4bdcd7d9dcd0245e704fc26eae462ca87c4b5" ] || \
        [ "$base_fixture_sha" != "fb013c5ed749f54c9a8f3f9528a1aeb957fe2b75b8eb93ab237e9d987305e0a7" ] || \
