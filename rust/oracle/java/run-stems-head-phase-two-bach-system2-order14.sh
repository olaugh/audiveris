...
if [ "$base_runner_sha" != "1fcb4e5bea6828394fb3a9c689a21aa01e8a1f86d442f90fd6e5918ed6b19a5a" ] || \
        [ "$base_fixture_sha" != "96496f2705872692114655481747336fc3cf93e745cc3233f9bcee05c4ab34c7" ]; then
