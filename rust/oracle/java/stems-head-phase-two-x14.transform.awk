...
# Add a bounded phase-two x14 C-link envelope to Java's production HeadLinker.
...
function emit_frontier() {
    print "                final boolean rustAudit = append && head.getId() == 1777"
    print "                        && hSide == HorizontalSide.RIGHT && vSide == VerticalSide.BOTTOM;"
    ...
    print "                            \"stemsheadphase2x14frontier headInterId %d corner %s \""
...
function emit_result() {
    ...
    print "                    System.out.printf("
    print "                            \"stemsheadphase2x14result headInterId %d linkedStem %s \""
