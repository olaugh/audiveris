...
if [ "$base_runner_sha" != "67ed9a70a31bbec72c3087248ee2d63771d4a8d58a18c66354437c166279a16d" ] || \
        [ "$base_fixture_sha" != "d11f10481ce7044ac3cde07d6f8e51d1e8c10ef4eb3d193a771b1189859fbe84" ]; then
