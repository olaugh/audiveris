...
if [ "$base_runner_sha" != "a06dd25df8f30d7e204760cfea1aafdeb6d1a106aed9e4279d9902a10391aff0" ] || \
        [ "$base_fixture_sha" != "863be30c6bdf8a69c982ffdfa68f6e1a00ff279235a81e5519d52711ba3fcb6f" ]; then
