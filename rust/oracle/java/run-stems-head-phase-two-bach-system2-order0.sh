...
if [ "$base_runner_sha" != "8bd7fee1f76c04ba2d92c3789a2d5b99d5c79d797622980e87f31937c45d7800" ] || \
        [ "$base_fixture_sha" != "8ce4bb110020fbbb4c62aab574fe2aaca8d6aced89f5797c75d9602e8866c54c" ]; then
