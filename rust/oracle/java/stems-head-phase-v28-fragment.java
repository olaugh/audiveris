            ...
            throws Exception
        {
            ...
            System.out.printf(
                    "stemsheadclinkfrontier %s system %d headOrder %d headX %d headSig %d headInterId %d "
                    ...
                    page, system.getId(), headOrder, headOrdinals.get(head), headSigOrdinals.get(head), head.getId(),
            ...
            throws Exception
        {
            ...
            System.out.printf(
                    "stemsheadclinkresult headOrder %d allocatorBefore %d allocatorAfter %d "
                    ...
                    headOrder, before.allocator, after.allocator, list(registeredGlyphs), list(addedVertices),
