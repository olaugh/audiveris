...
public final class StemsHeadPhaseTwoPageProbe {
    ...
    private StemsHeadPhaseTwoPageProbe() {}
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("stemsheadphase2page page %s systems %d mode ForegroundPageSerial%n",
