...
# Add a bounded phase-two x13 C-link envelope to Java's production HeadLinker.
...
function emit_frontier() {
    print "                final boolean rustAudit = append && head.getId() == 1675"
    ...
    print "                            \"stemsheadphase2x13frontier headInterId %d corner %s \""
...
function emit_result() {
    ...
    print "                    System.out.printf("
    print "                            \"stemsheadphase2x13result headInterId %d linkedStem %s \""
