...
3. Continue from Boundary 128 with the remaining four phase-2 append retries, then `reuseStem` appending, the rather-good profile escalation, and `finalizeStems`:
   carry the
