...
1. Starting from Boundary 139's native selected-beam identity, replace the first
   B14 compact state's shared persistent-ID seed and opaque InterIndex baseline.
   Glyph and selected-beam identities are now native, but new StemInter IDs
   still inherit Java allocator chronology.
