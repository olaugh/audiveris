...
3. Continue from Boundary 28 at head index 1: carry ordered phase-1 head iteration,
   rather-good retry/no-link closure, unlinked-head collection, phase-2 append retries,
   multi-item/recursive C-linkers, and the remaining head branches. In parallel, widen the bounded
