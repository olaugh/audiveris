...
widening later-system STUMPS are next.

## Next implementation slices

Commit each slice separately after the full verification block above.

1. Carry Boundary 151's terminal registry/allocator through system 3's
   constructors and first serial frontier, then widen later-system STUMPS. Do
   not reconstruct a later system in isolation. Then generalize
