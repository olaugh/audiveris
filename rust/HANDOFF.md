...
SHA-256 `6b607407d196cd7e37f23a4ca94b8b22ae1c38d7a523af127e95e718295fa939`;
...
with SHA-256 `691bafc9d14cb28d87ed131643cec4a711a236105020d6e19f6229af172ebbbf`.
Probe, runner, emitted-body, and semantic-pass SHA-256 are
`faa7c462059f0b7518c0ba6d8a756dfa89e666f01e4fef852cad8bafb54c2f80`,
...
`5b0154f89` Boundary 27 is the current CI baseline: all 12 Rust shards and the Java build
passed with no failure or cancellation.
...
`913d3b80c36bf821ae7c99560ba39f564bd54598d71376bfdaed4291f7c3e686`; the result
...
full local workspace, formatting, and strict all-target Clippy gates are green;
`5b0154f89` remains the current remote CI baseline. Native
...
fixture was expanded for that gate to 11 lines / 6,602 bytes—six semantic rows plus
summary—with SHA-256
`740140bef0fd1f34cca338463cdb9057f45da7026a3d97227611f87bce94efbe`.
Probe, runner, emitted-body, and semantic-pass SHA-256 are
`faa7c462059f0b7518c0ba6d8a756dfa89e666f01e4fef852cad8bafb54c2f80`,
`efe4e0f4a89e748556f5d36b6c12a4e9f8393538615d7343b5bdf006ae8dd986`,
`558b9df815f9ced297b7f7c687334a40cdd551da6a1208900c33d3d755293311`, and
`c927bde5eb77b3eccea9d226d3935e566ac87d47c9c1e8b8107f45a94bb5f368`.
Boundary 27's full local workspace, formatting, and strict all-target Clippy gates are
green. `5b0154f89` Boundary 27 is the current remote CI baseline: all 12 Rust
...
C-linking remain open. The expanded head-prefix fixture is 11 lines / 6,602 bytes—six
...
green. `5b0154f89` Boundary 27 remains the current remote-CI baseline until Boundary 28's
...
Boundary 29 continues phase 1 from Boundary 28's committed head frontier without
performing another SIG mutation. `continue_native_stems_head_linking_phase1` revalidates
the completed chula carrier, stable reverse-grade order, live head bindings, and
exhaustive persistent S-cell topology, then refreshes head order entry 1 (SIG ordinal
23 / Java Inter 1331). LEFT is already linked and RIGHT is open/unlinked; both RIGHT
STRICT corners are false, so native records one unlinked head, advances to
`current_index=2`, and leaves SIG, glyph, stem, allocator, and S-cell state unchanged.
The existing Boundary 28 `nextHeadSig`, `nextHeadInterId`, and `nextSides` rows are
consumed only after this native decision. Invalid consumed-frontier state rejects
unchanged. Later head C-link mutation, rather-good retry/closure, phase-2 append, and
broader head branches remain open.
...
3. Continue from Boundary 29 at head index 2: carry the ordered phase-1 queue after the
   recorded no-link head, then implement later head C-link mutation, rather-good
   retry/closure, unlinked-head collection, phase-2 append retries, multi-item/recursive
