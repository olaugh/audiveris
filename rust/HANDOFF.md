...
SHA-256 `19fcb9ff4527fbeb499a5a98ac5340ec456629f9ec84751214ff8da3fb00e9a4`;
...
with SHA-256 `a23dc34722d3cec118ae234b70968a2c79200a520bd958a144bd9b655f18d5e0`.
Probe, runner, emitted-body, and semantic-pass SHA-256 are
`0f362b50a4f04756c9aebe9a64a110d2ded4524de049b5660073ded6d86514e4`,
...
`392c0f350` Boundary 26 is the current CI baseline: all 12 Rust shards and the Java build
...
`d8babdb5d54354e5f8eefc3005bd0047b8a35969ac4ba68fe8f0efab438f8298`; the result
...
full local workspace, formatting, and strict all-target Clippy gates are green;
`392c0f350` remains the current remote CI baseline. Native
...
shared-cell mutation. The fixture's Java-only next row is evidence for that next slice:
linking the selected corner changes relations 0 to 1, vertices 678 to 679, edges 689 to
690, system stems 39 to 40, and RIGHT linked false to true before head 1. Native stops
before those changes. The fresh fixture is 8 lines / 2,614 bytes—three semantic rows plus
summary—with SHA-256
`0e06761ef67d2847e7d89cdd640deefe54129e12ea7aa5ebd4122896c2c86888`.
Probe, runner, emitted-body, and semantic-pass SHA-256 are
`0f362b50a4f04756c9aebe9a64a110d2ded4524de049b5660073ded6d86514e4`,
`a6c4b20d78e2fc027cb5ef3548ba4d0cd96a4f1d9066d25e4d2c4d71ba32eaeb`,
`797284afe7509f372f3e87f502038f27b84b3249813c18ba7785334172787a4a`, and
`ad4628b9825a42120e9213f232e3a0b07cd5f838862aa94e350c694cbc4a910c`.
Boundary 27's full local workspace, formatting, and strict all-target Clippy gates are
green. `392c0f350` Boundary 26 remains the current remote CI baseline: all 12 Rust
...
3. Implement the selected head-origin `HeadLinker.CLinker.link` transaction from the
   Boundary-27 typed frontier, then carry ordered phase-1 heads, unlinked-head collection,
   phase-2 append retries, and the remaining head branches. In parallel, widen the bounded
