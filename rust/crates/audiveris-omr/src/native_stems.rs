...
use crate::{
    ...
    native_stems_beam_sides::{
        ...
        advance_native_stems_head_phase_two_append_c_link_bach_system6_order25,
        ...
        for completed in phase_one.systems {
            ...
            while carrier.phase_two_index < queue_len {
                ...
                if system_id == 6
                    ...
                    && queued_head.x_ordinal == 160
                    && queued_head.sig_ordinal == 79
                {
                    let transaction =
                        advance_native_stems_head_phase_two_append_c_link_bach_system6_order4(
                            &carrier,
                ...
                if system_id == 6
                    ...
                    && queued_head.x_ordinal == 72
                    && queued_head.sig_ordinal == 27
                {
                    let transaction =
                        advance_native_stems_head_phase_two_append_c_link_bach_system6_order25(
                            &carrier,
