...
| Rust workspace | 501 tests green at checkpoint 192: core 38, image 348, OMR 94, testkit 6, CLI 4, xtask 5 |
...
| GRID coordinator | exact `GridStep.doit` order through builder, staff-line cleanup, and score regrouping; Java-compatible outer exception semantics plus a separate transactional LinesRetriever-before-BarsRetriever join; StaffLineCleaner simplification/removal/rebuild/population lifecycle; no-staff horizontal-lag rebuild; sequential staff validation; source-order system population, curved line/quadratic/cubic areas and side-by-side slicing, section ownership, indentation, physical-page/PageRef allocation, and report maxima; `SystemInfo.buildRef`, concrete sheet executor attachment, broader glyph/index ownership, and production SIG mutation remain queued |
