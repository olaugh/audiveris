...
| HEADS active small-head catalog | Boundary 298 passes the exact qualified `ProcessingSwitches.smallHeads` value into production HEADS and selects Java's eight normal/small scanner and factory orders while leaving the default four-shape wrapper unchanged. A fresh Temurin-25 corpus oracle freezes five point sizes, 64 page templates, 384 anchors, and 41,492 keyed pixels (SHA-256 `0f1c86ff8a8318520faeeb43e3375b5c76301eb163ba0cd4442b8ccb1180f832`). The generated 160,857-byte asset contains 40 unique templates and is pinned at `30b60d5d27f6d7bc8ee71413539b7ca159844e29e6f0abcd06e00e1a4304ddea`. Batuque's live result matches Java at 155 normal black, 170 normal void, 221 small black, and 150 small void heads; the normal-black-only hole correction is preserved, and all 696 stemmed heads reach 2,784 STEMS corners. Active CUE_BEAMS aggregation/morphology remains unavailable. |
