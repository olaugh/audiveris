...
| Rust workspace | 874 tests green at checkpoint 302: core 38, image 505, OMR 310, testkit 6, CLI 4, xtask 5, classifier 6 |
...
| Visual classifier core | native immutable parser/inference for the frozen bundled 110→149→149 `BasicClassifier` model, including Java normalization, bias-first sigmoid layers, and point-list `MixGlyphDescriptor` ART/geometric/aspect extraction; RunTable/Glyph adaption, rank/minimum-grade policy, overrides, and MusicFont metrics remain unported |
