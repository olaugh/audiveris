...
| Native recognition entry | `audiveris_omr::recognize` runs LOAD-BINARY-SCALE on a raster with production settings; `audiveris-cli -batch -step SCALE` prints the report; chula frozen-oracle values locked by test |
