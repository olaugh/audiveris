...
The first eighteen semantic `STEMS` boundaries are production-shaped and graded (the eighteenth under the fast-evidence policy documented in `rust/PORTING.md`).
