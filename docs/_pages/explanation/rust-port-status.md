...
| 12 | `CUE_BEAMS` | **Default path published** | Exact default `smallHeads=false` prolog skip, typed active-path refusal, schema-1 ordinary/stream output, plus dependency-light active lifecycle/contracts. | Active cue-aggregate recognition and linking. |
