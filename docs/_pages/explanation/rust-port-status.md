...
reaches `current_index=96` before x75 / SIG 96 / Java Inter 1481 (grade bits
`0x3fd054794ef2dcc3`).
...
`current_index=96` before x49 / SIG 71 / Java Inter 1431 (grade bits
`0x3fd021ddca571190`).
...
`current_index=96` before x31 / SIG 47 / Java Inter 1381 (grade bits
`0x3fd0159c0e3e20aa`).
...
heads (x32, x71, x70, x0, x31). Native reaches `current_index=96` before
...
`current_index=96` before x64 / SIG 94 / Java Inter 1477 (grade bits
`0x3fcff9236d861040`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x82 / SIG 20 / Java Inter 1325 (grade bits
`0x3fcfa2c1fa2c1fa4`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x17 / SIG 10 / Java Inter 1305 (grade bits
`0x3fcf415c201e6454`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x29 / SIG 66 / Java Inter 1421 (grade bits
`0x3fcf16ffe269a2da`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x98 / SIG 60 / Java Inter 1409 (grade bits
`0x3fced4aaff369490`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x80 / SIG 32 / Java Inter 1349 (grade bits
`0x3fce89638b9d6c74`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x24 / SIG 90 / Java Inter 1469 (grade bits
`0x3fce2861757a9720`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x94 / SIG 99 / Java Inter 1487 (grade bits
`0x3fcd7bb8913d63fa`).
...
unchanged. Native reaches `current_index=96` before x79 / SIG 40 / Java
...
Native reaches `current_index=96` before x51 / SIG 82 / Java Inter 1453
...
four writes. No vertex, edge, allocator, registry, or system-stem mutation.
The five carried undefined LEFT sides and the five-head phase-2 queue stay
unchanged. Native reaches `current_index=96` before x45 / SIG 56 / Java
...
four writes. No vertex, edge, allocator, registry, or system-stem mutation.
The five carried undefined LEFT sides and the five-head phase-2 queue stay
unchanged. Native reaches `current_index=96` before x72 / SIG 101 / Java
...
unchanged. Native reaches `current_index=96` before x47 / SIG 28 / Java
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x27 / SIG 54 / Java Inter 1397 (grade bits
`0x3fcab4d72d66a100`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x91 / SIG 98 / Java Inter 1485 (grade bits
`0x3fca8b5eeb934dcd`).
...
No vertex, edge, allocator, registry, or system-stem mutation. The five
carried undefined LEFT sides and the five-head phase-2 queue stay unchanged.
Native reaches `current_index=96` before x54 / SIG 78 / Java Inter 1445
...
No vertex, edge, allocator, registry, or system-stem mutation. The five
carried undefined LEFT sides and the five-head phase-2 queue stay unchanged.
Native reaches `current_index=96` before x37 / SIG 44 / Java Inter 1373
...
reaches `current_index=96` before x96 / SIG 41 / Java Inter 1367 (grade bits
`0x3fc9594769788bd0`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x7 / SIG 52 / Java Inter 1393 (grade bits
`0x3fc84a2df584a2e0`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=96` before x60 / SIG 30 / Java Inter 1345 (grade bits
`0x3fc7ade95f81b5cd`).
