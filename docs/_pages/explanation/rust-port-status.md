...
No Java process-global glyph or SIG ID is fabricated. Range lookup is the next
HEADS boundary.
...
1. Freeze and port range lookup, including aggregation, seed-head conflict filtering, and glyph retrieval.
