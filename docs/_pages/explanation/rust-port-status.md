...
reaches `current_index=74` before x75 / SIG 96 / Java Inter 1481 (grade bits
`0x3fd054794ef2dcc3`).
...
`current_index=74` before x49 / SIG 71 / Java Inter 1431 (grade bits
`0x3fd021ddca571190`).
