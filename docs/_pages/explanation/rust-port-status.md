...
1. Retain BEAMS' final group membership and `MultipleRestsBuilder` replacement state for HEADS.
2. Port and grade the frozen HEADS base competitor/bar rectangle slices.
