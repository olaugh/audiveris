...
Native range scanning and post-processing are the active implementation
boundary.
...
1. Port the frozen range lookup, including aggregation, seed-head conflict filtering, and glyph retrieval.
