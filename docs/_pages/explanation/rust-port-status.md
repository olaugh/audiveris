...
1. Materialize and grade all frozen active head-template catalog records.
2. Connect the native evaluator and HEADS scanner geometry to each staff catalog.
