...
The current STEMS checkpoint is Boundary 269. All eight frozen parity pages and
the additional D039 real page complete Rust-only schema-1 STEMS publication;
...
records the chain through Boundary 258; Boundaries 259-269 are summarized in
