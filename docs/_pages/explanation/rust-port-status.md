...
reaches `current_index=88` before x75 / SIG 96 / Java Inter 1481 (grade bits
`0x3fd054794ef2dcc3`).
...
`current_index=88` before x49 / SIG 71 / Java Inter 1431 (grade bits
`0x3fd021ddca571190`).
...
`current_index=88` before x31 / SIG 47 / Java Inter 1381 (grade bits
`0x3fd0159c0e3e20aa`).
...
heads (x32, x71, x70, x0, x31). Native reaches `current_index=88` before
...
`current_index=88` before x64 / SIG 94 / Java Inter 1477 (grade bits
`0x3fcff9236d861040`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=88` before x82 / SIG 20 / Java Inter 1325 (grade bits
`0x3fcfa2c1fa2c1fa4`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=88` before x17 / SIG 10 / Java Inter 1305 (grade bits
`0x3fcf415c201e6454`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=88` before x29 / SIG 66 / Java Inter 1421 (grade bits
`0x3fcf16ffe269a2da`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=88` before x98 / SIG 60 / Java Inter 1409 (grade bits
`0x3fced4aaff369490`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=88` before x80 / SIG 32 / Java Inter 1349 (grade bits
`0x3fce89638b9d6c74`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=88` before x24 / SIG 90 / Java Inter 1469 (grade bits
`0x3fce2861757a9720`).
...
registry, or system-stem mutation. The five carried undefined LEFT sides and
the five-head phase-2 queue stay unchanged. Native reaches
`current_index=88` before x94 / SIG 99 / Java Inter 1487 (grade bits
`0x3fcd7bb8913d63fa`).
...
unchanged. Native reaches `current_index=88` before x79 / SIG 40 / Java
...
Native reaches `current_index=88` before x51 / SIG 82 / Java Inter 1453
...
four writes. No vertex, edge, allocator, registry, or system-stem mutation.
The five carried undefined LEFT sides and the five-head phase-2 queue stay
unchanged. Native reaches `current_index=88` before x45 / SIG 56 / Java
...
four writes. No vertex, edge, allocator, registry, or system-stem mutation.
The five carried undefined LEFT sides and the five-head phase-2 queue stay
unchanged. Native reaches `current_index=88` before x72 / SIG 101 / Java
