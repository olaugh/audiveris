...
precision. This checkpoint stops honestly before `HeadInter.retrieveGlyph`,
SIG insertion, and final tally ownership.
...
1. Materialize seed-head glyphs, SIG insertion, and identity-keyed tally state against the frozen final-head rows.
