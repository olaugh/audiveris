...
rectangle IoU, and inclusive seed-conflict gates. Native streaming range
scanning and end-to-end composition are the active implementation boundary.
...
1. Port the frozen streaming range scan and compose it through native aggregation, seed-head conflict filtering, and glyph retrieval.
