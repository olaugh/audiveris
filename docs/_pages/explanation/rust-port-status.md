...
bound, ordered seed slice, and ordered spot slice matches Java (15,343 and
6,759 references).
Bar and competitor slice composition is the active next boundary.
...
1. Compose and grade the frozen HEADS bar and final competitor rectangle slices.
