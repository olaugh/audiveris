...
the native semantic-overlap and seed-search differential against that fixture.
...
1. Port dynamic seed-head and per-template Java2D overlap decisions against the frozen 61,372-search seed-pass oracle.
