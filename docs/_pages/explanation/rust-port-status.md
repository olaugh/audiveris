...
The first nineteen semantic `STEMS` boundaries are production-shaped and graded (the eighteenth and nineteenth under the fast-evidence policy documented in `rust/PORTING.md`).
